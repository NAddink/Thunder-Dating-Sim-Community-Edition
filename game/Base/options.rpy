...
define config.name = _("Thunder Dating Sim CE")
define config.mouse = { }
define config.mouse['default'] = [ ( "gui/cursor-32.png", 8, 20) ]
...
define build.name = "ThunderDatingSim"
...
define config.main_menu_music = "BGM/main_menu_theme.opus"
...
define config.save_directory = "ThunderDatingSim-1697078218"
...
init python:
    renpy.music.register_channel("text", "text", stop_on_mute = True)
